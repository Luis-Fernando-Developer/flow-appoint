...
const ClienteMenuItems = [
  { title: 'Relatórios', url: '/client/dashboard', icon: LayoutDashboard,  current: true },
  { title: 'Meus Agendamentos', url: '/client/appointments', icon: Calendar, current: false },
  { title: 'Meu perfil', url: '/client/profile', icon: User, current: false },
